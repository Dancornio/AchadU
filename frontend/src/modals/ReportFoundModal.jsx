...
export default function ReportFoundModal({ onClose }) {
    ...
    <div className="fixed inset-0 z-30 flex items-center justify-center bg-black/40">
      <div className="bg-white rounded-lg shadow-lg w-full max-w-md p-4">
        <div className="flex items-center justify-between">
          <h3 className="font-semibold text-gray-900">Reportar item encontrado</h3>
        ...
        <form className="mt-3 space-y-3" onSubmit={submit}>
          ...
          <div className="flex justify-end gap-2">
            ...
            <button type="submit" disabled={saving} className="h-10 px-3 rounded-lg bg-gray-900 text-white">{saving? 'Enviando...' : 'Enviar'}</button>
          </div>
        </form>
      </div>
    </div>
